...
<div className='c3-left'>
    ...
    <h1>Sacramento Rehab makes getting treatment <i><span>simple</span></i></h1>
    <p>Your personal medical assistant is always a message away for anything you need, at no cost.</p>
...
<div className='c3-right'>
    ...
    <div className='c3-card c3-card1'>
        <div className='c2-card-img'>
        </div>
        <div className='c3-card-flex'>
            <h2>< BiBrain/></h2>
        <h1>STRESS MANAGEMENT</h1>
    </div>
    <p>Answer a few questions about your medical history to match with your free medical assistant.</p>
